...
import { TreeDeciduous, X, ExternalLink, Building2, LayoutDashboard, ChevronDown, Youtube, Newspaper } from 'lucide-react';
                ...
                <div className="bg-gradient-to-br from-stone-800 to-stone-900 border border-stone-700 p-10 rounded-3xl relative shadow-2xl">
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-start gap-4 text-stone-300">
                            <div className="text-emerald-500 shrink-0 mt-0.5"><TreeDeciduous size={20} /></div>
